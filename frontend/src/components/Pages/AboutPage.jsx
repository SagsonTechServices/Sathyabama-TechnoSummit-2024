...
function AboutPage() {
    return (
        <div className="flex flex-col px-10 py-20">
            <Heading2 text="About Sathyabama Institue of Science and Technology"></Heading2>
            <div className="flex flex-col gap-5 py-7 md:grid md:grid-cols-2">
                <img src='./src/assets/sist-1.jpg'></img>
                <img src='./src/assets/sist-2.jpg' className="w-full h-auto"></img>
            </div>
