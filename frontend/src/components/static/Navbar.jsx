                            ...
                            <li className='md:block hidden'>
                                <details>
                                    ...
                                    <ul className="p-2 bg-white text-base-100 font-semibold w-52">
                                        ...
                                        <li><Link to={'/event/3'}>Buildathon</Link></li>
                                        ...
                                        <li><Link to={'/event/14'}>Go Karting</Link></li>
                                        <li><Link to={'/event/15'}>Drones and Robotics Design challenge</Link></li>
                                    </ul>
                                </details>
                            </li>
                            <li><a href="/venues">Venue Information</a></li>
                        </ul>
                    </div>
